<script lang="ts">
	...
	const chooseRestaurant = (id: number) => () => {
		selectedRest = restaurants.find((restaurant) => restaurant.id === id) as Restaurant;
	};
</script>

<div class="flex justify-center items-center background w-full h-screen fixed top-0 left-0">
	<Card.Root class="w-1/4">
		<Card.Header class="items-center">
			<Card.Title class="font-bold text-5xl">Spiza</Card.Title>
		</Card.Header>
		<Card.Content>
			<Select.Root>
				<Select.Trigger>
					<Select.Value placeholder="Select a restaurant" />
				</Select.Trigger>
				<Select.Content>
					{#each restaurants as restaurant}
						<div>
							<Select.Item
								on:click={chooseRestaurant(restaurant.id)}
								value={restaurant.id}
			...
			{#if selectedRest}
				<Button class="mt-2 w-full" href="/restaurant/{selectedRest.id}">Login</Button>
			{/if}
		</Card.Content>
	</Card.Root>
</div>
